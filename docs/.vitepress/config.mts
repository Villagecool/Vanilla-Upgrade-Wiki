...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: 'Copyright © 2024-present Vlliage & Team Various'
    },
    socialLinks: [
      ...
      { icon: { svg: '<img src = "/ass-sets/dlboxsvg.png" alt="MCPEDL" width = 24 height = 24/>' }, link: 'https://mcpedl.com/vanilla-upgrade-addon/', ariaLabel: 'MCPEDL' }
    ]
  }
})
